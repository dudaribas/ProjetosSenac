...
<body>
  <div id="home"></div>
	...
	<nav>
		<img src=""/> 
		<h1 class="tata" ><a><img class="bi" width="50" height="50" src="./imgs/comp.jpg"></a></img>ProaPets</h1>
...
<div id="atendimento">
  <h1 class="atendi">Atendimento personalizado pra você!</h1>
    ...
    <div id="mapa">
    <div class="mapa">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3658.122569094284!2d-46.69400408502285!3d-23.52809358469939!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cef8775663b04f%3A0x923835e9005f8309!2sSenac%20Lapa%20Tito!5e0!3m2!1spt-BR!2sbr!4v1677287254266!5m2!1spt-BR!2sbr" width="500" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3654.17152601142!2d-46.703646074130184!3d-23.669823222310736!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce515bb231b5ed%3A0x327b78892baef8e6!2zU2VuYWMgTmHDp8O1ZXMgVW5pZGFz!5e0!3m2!1spt-BR!2sbr!4v1677287335988!5m2!1spt-BR!2sbr" width="500" height="350" style="border:0;" allowfullscreen="" loading="lazy" class="mapa2" referrerpolicy="no-referrer-when-downgrade"></iframe>  
    </div> 
        <p class="texxt">Nossos PetShops tem duas unidades:Rua Tito, 54. Ou Avenida Engenheiro Eusébio Stevaux, 823. Confira os mapas acima.</p>
</div>
      <div id="produtos">
...
<div id="sobrenos">
  ...
  <div class="cardes">
    <div class="cardone">
      <img class="nos" src="./imgs/claudia.jpeg" alt="Dra. Claudia">
      <div class="infos">
        <h6 class="nome">Dra. Claudia</h6>
        <p class="info">Formada em Medicina Veterinária na FMU em 2017 e especializada em Clínica Médica.</p>
      </div>
    </div>
    <div class="cardone">
      <img class="nos" src="./imgs/luis.jpeg" alt="Dr. Luis">
      <div class="infos">
        <h6 class="nome">Dr. Luis</h6>
        <p class="info">Bacharelado em Medicina Veterinária na USP em 2015 e pós-graduado em Anestesiologia de cães e gatos.</p>
      </div>
    </div>
    <div class="cardone">
      <img class="nos" src="./imgs/gabriel.jpeg" alt="Dr. Gabriel">
      <div class="infos">
        <h6 class="nome">Dr. Gabriel</h6>
        <p class="info">Curso técnico de Veterinária na FAMESP em 2020 e especializado em Dermatologia Veterinária.</p>
      </div>
    </div>
    <div class="cardone">
      <img class="nos" src="./imgs/eduarda4.jpeg" alt="Dra. Eduarda">
      <div class="infos">
...
<footer>
    <div class="tudo">
        ...
        <div class="texto">
         ...
         <P class="textinho">&copy; 2023 ProaPets, Inc. Todos os direitos reservados.</P>
    </div>
</footer>
</body>
</html>